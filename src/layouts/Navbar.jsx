...
const TextNav = () => {
    ...
    return (
        <section 
            className='w-full h-[30px] absolute top-0 z-20 flex justify-between px-6 2xl:px-16
                '>     
            <div className="w-full flex justify-between mt-6 2xl:mt-8">
                <div className="flex w-full relative gap-2 2xl:gap-[44rem] ">
                    ...
                    <div className='flex w-full relative items-center'>       
                        <ul className='w-[68%] 2xl:w-[18vw] flex justify-between items-start gap-2 2xl:gap-2
                            text-xxsmall-white mr-12 mt-12 2xl:mt-4'>               
