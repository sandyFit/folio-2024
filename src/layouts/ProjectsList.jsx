                ...
                <ul className="flex flex-col items-start lg:items-end relative w-[40%] lg:w-[40vw] projects">
                    {projects.map((project, index) => (
                        <li key={index} className={`flex flex-grow relative pb-12 ${openProjectIndex === index ? 'expanded' : ''}`}>
                            <div className="absolute left-0 top-0 w-full h-[1px] bg-cyan-300 transition-all duration-[var(--duration)] ease-[var(--ease)]"></div>
                            <div className="flex w-full cursor-pointer">
                                <div className="flex relative">
                                    ...
                                    <div className="flex xsm-title-d absolute left-7 lg:left-[2.2rem] top-3 lg:top-2">
                                        {`00${index + 1}`}
                                    </div>
                                </div>
